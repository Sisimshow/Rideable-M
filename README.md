...
> Personal fork of [Rideable](https://github.com/Saibot393/Rideable) by Saibot393, targeting Foundry v13. The token-following system has been substantially rewritten and no longer matches upstream behavior; other features track the original closely. Not affiliated with or supported by the upstream project — please don't file issues about this fork on their repo.
...
- Snap followers to grid: to snap following tokens' movement destination to the grid
- Follower elevation: to set how following tokens handle their elevation relative to the token they follow (followers of the same token are automatically prevented from stacking on one another)
#### Client:
...
This fork targets Foundry v13, though a few features are only available for the Pf2e system. Movement modules such as the Drag Ruler should work fine with the module. If you encounter any bugs please [let me know](https://github.com/sisimshow/rideable-m/issues).
...
The module contains an English, a German, a French (thanks to [wirgeen](https://github.com/wirgeen)), an Italien (thanks to [Landscape](https://github.com/LandscapeNemo)), and a Polish (thanks to [Lioheart](https://github.com/Lioheart)) translation, inherited from upstream. If you want additional languages to be supported [let me know](https://github.com/sisimshow/rideable-m/issues).
...
**If you have suggestions, questions, or requests for additional features please [let me know](https://github.com/sisimshow/rideable-m/issues).**
