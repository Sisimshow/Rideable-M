...
Hooks.once("init", () => {  // game.settings.get(cModuleName, "")
  ...
  game.settings.register(cModuleName, "FollowingGridSnap", {
	name: Translate("Settings.FollowingGridSnap.name"),
	hint: Translate("Settings.FollowingGridSnap.descrp"),
	scope: "world",
	config: game.settings.get(cModuleName, "EnableFollowing"),
	type: Boolean,
	default: true
  ...
  game.settings.register(cModuleName, "FollowerElevation", {
	name: Translate("Settings.FollowerElevation.name"),
	hint: Translate("Settings.FollowerElevation.descrp"),
	scope: "world",
	config: game.settings.get(cModuleName, "EnableFollowing"),
	type: String,
	choices: {
		"delta": Translate("Settings.FollowerElevation.options.delta"),
		"leader": Translate("Settings.FollowerElevation.options.leader"),
		"ignore": Translate("Settings.FollowerElevation.options.ignore")
	},
	default: "delta"
  });
  ...
  game.settings.register(cModuleName, "OnFollowerMovement", {
	...
	choices: {
		...
		"continuefollowing": Translate("Settings.OnFollowerMovement.options.continuefollowing")
	},
